...
def test_boundary_uses_tensor_sign_rule() -> None:
    ...
    left_parent = Surjection(2)
    right_parent = Surjection(2)
...
def test_compose_is_diagonal_on_factors() -> None:
    ...
    right_composed = Surjection.compose(Surjection(2)((1, 2)), 1, Surjection(2)((1, 2)))

    expected = had(3).from_factors(left_composed, right_composed)
...
def test_permutation_is_diagonal_action() -> None:
    ...
    left = Lie(2)((1,)).permute(sigma)
    right = Lie(2)((1,)).permute(sigma)
