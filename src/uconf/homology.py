...
def _boundary_matrix(
    ...
    *,
    ...
    # If the module supports planar normalisation (CofreeCoalgebraModule and
    # subclasses), apply it so that boundary terms with non-planar cooperad
    # keys are rewritten in the planar basis used by basis_iter / graded_basis.
